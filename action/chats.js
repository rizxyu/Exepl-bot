...
else console.log(Ft['color']('\x1b[1;37m>', 'cyan'), Ft['color']('[MSG]'), Ft['color'](Ft['moment'].tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm'), 'cyan'), Ft['color']('Message', 'red'), 'Dari', Ft['color'](await this.getName(m.sender)));
